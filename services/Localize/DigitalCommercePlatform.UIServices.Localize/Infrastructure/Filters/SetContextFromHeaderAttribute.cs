...
namespace DigitalCommercePlatform.UIServices.Localize.Infrastructure.Filters
{
    ...
    public class SetContextFromHeaderFilter : IAsyncActionFilter
    {
        ...
        public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
            ...
            if (validationErrors.Any())
            {
                ...
                {
                    Error = new ErrorInformation { IsError = true, Messages = validationErrors, Code = 500 } // to agree about code
                });
                return;
            }
