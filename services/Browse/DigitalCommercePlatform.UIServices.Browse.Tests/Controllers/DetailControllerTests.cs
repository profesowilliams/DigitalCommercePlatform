...
namespace DigitalCommercePlatform.UIServices.Browse.Tests.Controllers
{
    public class DetailControllerTests
    {
        ...
        private readonly Mock<ILogger<DetailController>> mockLoggerFactory;
        ...
        public DetailControllerTests()
        {
            ...
            mockLoggerFactory = new Mock<ILogger<DetailController>>();
        ...
        private DetailController GetController()
        {
            return new DetailController(mockMediator.Object, mockLoggerFactory.Object, mockContext.Object,
