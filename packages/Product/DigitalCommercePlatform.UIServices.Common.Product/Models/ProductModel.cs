...
namespace DigitalCommercePlatform.UIServices.Common.Product.Models
{
    ...
    public class ProductModel
    {
        ...
        public List<MainSpecificationModel> MainSpecification { get; set; }
        public List<ExtendedSpecificationModel> ExtendedSpecification { get; set; }
        public IDictionary<string, List<ImageModel>> Images { get; set; }
