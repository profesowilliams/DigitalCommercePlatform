variable "environment" {
  ...
  default = "Terraform-globalsite-efix"
}
variable "host_name" {
  description = "Please provide hostname for VM"
  default = "amer-east-aem-globalsite-efix"
}
variable "resourcegroup" {
  description = "Please enter Resource group name:"
  default = "amer-east-aem-globalsite-efix-rg"
}
variable "environment-name" {
 default = "amer-east-aem-globalsite-efix"
}
variable "aem-domain-author" {
  default = "us-efix-author.tdebusiness.cloud"
}
variable "aem-domain-publish" {
  default = "us-efix.tdebusiness.cloud"
}
variable "incaps_dns" {
