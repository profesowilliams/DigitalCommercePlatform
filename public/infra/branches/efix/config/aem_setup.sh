...
sed -i '$ a sling.run.modes=efix' sling.properties
...
curl -s -u admin:admin -Fplain=ICIFGWKV7ZFWFaFFmJOE -Fverify=ICIFGWKV7ZFWFaFFmJOE  -Fold=admin -FPath=$USER_PATH http://localhost:4502/crx/explorer/ui/setpassword.jsp
sleep 60
echo "======================================================================"
echo "Resetting admin password for Author ..."
echo "======================================================================"
curl -s -u admin:admin -Fplain=ICIFGWKV7ZFWFaFFmJOE -Fverify=ICIFGWKV7ZFWFaFFmJOE  -Fold=admin -FPath=$USER_PATH http://localhost:4503/crx/explorer/ui/setpassword.jsp
sleep 60
echo "======================================================================"
