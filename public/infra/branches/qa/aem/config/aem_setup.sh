...
nohup java -jar cq5-author-p4502.jar -Dsling.run.modes=author,nosamplecontent & > /dev/null
...
curl -s -u admin:admin -Fplain=ormycK0uOY1qC88gUHOf -Fverify=ormycK0uOY1qC88gUHOf  -Fold=admin -FPath=$USER_PATH http://localhost:4502/crx/explorer/ui/setpassword.jsp
sleep 60
echo "======================================================================"
echo "Resetting admin password for Author ..."
echo "======================================================================"
curl -s -u admin:admin -Fplain=ormycK0uOY1qC88gUHOf -Fverify=ormycK0uOY1qC88gUHOf  -Fold=admin -FPath=$USER_PATH http://localhost:4503/crx/explorer/ui/setpassword.jsp
sleep 60
echo "======================================================================"
