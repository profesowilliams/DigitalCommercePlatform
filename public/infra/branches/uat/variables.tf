variable "environment" {
  ...
  default = "Terraform-globalsite-uat"
}
variable "host_name" {
  description = "Please provide hostname for VM"
  default = "amer-east-aem-globalsite-uat"
}
variable "resourcegroup" {
  description = "Please enter Resource group name:"
  default = "amer-east-aem-globalsite-uat-rg"
}
variable "environment-name" {
 default = "amer-east-aem-globalsite-uat"
}
variable "aem-domain-author" {
  default = "us-uat-author.tdebusiness.cloud"
}
variable "aem-domain-publish" {
  default = "us-uat.tdebusiness.cloud"
}
variable "incaps_dns" {
