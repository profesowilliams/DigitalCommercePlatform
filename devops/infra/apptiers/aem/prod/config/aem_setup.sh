...
sed -i '$ a sling.run.modes=prod' sling.properties
...
curl -s -u admin:admin -Fplain=9qQAi8o2neJAn5IQXcx7 -Fverify=9qQAi8o2neJAn5IQXcx7  -Fold=admin -FPath=$USER_PATH http://localhost:4502/crx/explorer/ui/setpassword.jsp
sleep 60
echo "======================================================================"
echo "Resetting admin password for Author ..."
echo "======================================================================"
curl -s -u admin:admin -Fplain=9qQAi8o2neJAn5IQXcx7 -Fverify=9qQAi8o2neJAn5IQXcx7  -Fold=admin -FPath=$USER_PATH http://localhost:4503/crx/explorer/ui/setpassword.jsp
sleep 60
echo "======================================================================"
