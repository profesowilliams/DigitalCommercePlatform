...
#  resourcegroup       = module.aem-vm.resourcegroup
...
#    {
#      backend_address_pool_name = local.backend_address_pool_author
#      backend_ip_addresses      = ["172.23.136.68", "172.23.136.69"]
#    },
    {
  ...
  ssl_certificates = [
    {
      name      = local.cert_s1nextgen_name
      file_path = "../common/script/certs/s1nextgen.com.pfx"
      password  = var.cert_s1nextgen_password
    }
  ]
  ...
  listeners = [
    {
      ...
      ssl_certificate_name = local.cert_s1nextgen_name
    },
    {
