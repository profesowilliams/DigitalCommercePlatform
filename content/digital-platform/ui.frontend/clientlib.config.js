module.exports = {
    ...
    clientLibRoot: "./../ui.apps/src/main/content/jcr_root/apps/digital-platform/clientlibs",

    libs: [
        {
            name: "clientlib-dependencies",
            allowProxy: true,
            categories: ["digital-platform.dependencies"],
        ...
        },
        {
            name: "clientlib-site",
            allowProxy: true,
            categories: ["digital-platform.site"],
            dependencies: ["digital-platform.dependencies"],
            serializationFormat: "xml",
            cssProcessor : ["default:none", "min:none"],
            jsProcessor: ["default:none", "min:none"],
            assets: {
