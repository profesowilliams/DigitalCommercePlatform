  ...
  const columnDefinitionsOverride = [
    {
      ...
      headerName: getDictionaryValueOrKey(
        config?.orderLineDetailsShippedColumnLabels?.dropdownArrow
      ),
    ...
    },
    {
      ...
      headerName: getDictionaryValueOrKey(
        config?.orderLineDetailsShippedColumnLabels?.shipDate
      ),
      cellRenderer: ({ data }) => (
    ...
    },
    {
      field: 'deliveryNotes',
      headerName: getDictionaryValueOrKey(
        config?.orderLineDetailsShippedColumnLabels?.dnote
      ),
      cellRenderer: ({ data }) => (
        <DNoteColumn
          line={data}
    ...
    },
    {
      field: 'invoices',
      headerName: getDictionaryValueOrKey(
        config?.orderLineDetailsShippedColumnLabels?.invoice
      ),
      cellRenderer: ({ data }) => (
        <InvoiceColumn
          line={data}
    ...
    },
    {
      field: 'totalPrice',
      headerName: getDictionaryValueOrKey(
        config?.orderLineDetailsShippedColumnLabels?.value
      ),
    ...
    },
    {
      field: 'quantity',
      headerName: getDictionaryValueOrKey(
        config?.orderLineDetailsShippedColumnLabels?.qty
      ),
