                ...
                return (
                    event.value ? (
                        <div>
                            ...
                            {event.value.contact.phone && <div>{event.value.contact.phone}</div>}
                        </div>
                    ) : <div>-</div>
                );
            case 'Ship to':
                return (
                    event.value ? (
                        <div>
                            {event.value.name && <div>{event.value.name}</div>}
                            {event.value.address.line1 && <div>{event.value.address.line1}</div>}
                            {event.value.address.line2 && <div>{event.value.address.line2}</div>}
                            {event.value.address.line3 && <div>{event.value.address.line3}</div>}
                            {(event.value.address.city || event.value.address.state || event.value.address.zip || event.value.address.country) && <div>
                                {event.value.address.city && <span>{event.value.address.city}&nbsp;</span>}
                                {event.value.address.state && <span>{event.value.address.state}&nbsp;</span>}
                                {event.value.address.zip && <span>{event.value.address.zip}&nbsp;</span>}
                                {event.value.address.country && <span>{event.value.address.country}</span>}
                            </div>}
                        </div>
                    ) : <div>-</div>
                );
