                ...
                return {
                    items: function() {
                        ...
                        that._elements.self.items.getAll().forEach(function(item) {
                            ...
                            if($(item).find('.coral3-Checkbox-input').attr('value') == 'false') {
                                items.push({
                                    name: name,
                ...
                if (ns) {
                    Coral.commons.ready(that._elements.add, function() {
                        that._elements.add.on("click", function() {
                            ...
                            var textFieldClone = $('.cmp-childreneditor__item .coral-textfield-custom:first').clone();
                            var checkBoxClone = $('.cmp-childreneditor__item .coral3-Checkbox:first').clone();
                                    ...
                                    selectList.on("coral-selectlist:change" + NS, function(event) {
                                        ...
                                        if (components.length > 0) {
                                            ...
                                            Coral.commons.nextFrame(function() {
                                                ...
                                                $(item).find('.cmp-childreneditor__item').append(checkBoxClone);
                                                $(item).find('.cmp-childreneditor__item').append(textFieldClone);
