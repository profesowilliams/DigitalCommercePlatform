...
const createColumnWithTryCatch = (fn) => withTryCatch((definition, bussinesConfig = {}) => fn(definition, bussinesConfig));

const columnTypes = {
  plainText: createColumnWithTryCatch(createColumn),
  buttonList: createColumnWithTryCatch(createColumn),
  plainResellerColumn: createColumnWithTryCatch((definition, bussinesConfig = {}) => {
    if (!isHouseAccount()) {
