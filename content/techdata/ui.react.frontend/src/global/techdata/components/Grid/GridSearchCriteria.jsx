...
function GridSearchCriteria({
  ...
  return (
    <div
      className={`cmp-search-criteria ${
        expanded ? "cmp-search-criteria--expanded" : ""
      }`}
    >
      <div
      ...
      >
        ...
        <div className="cmp-search-criteria__header__title">
          {label ?? "Filter"}
        </div>
      </div>
      <div
        className={`cmp-search-criteria__content  ${
          !expanded ? "cmp-search-criteria__content--hidden" : ""
        }`}
      >
        ...
        <div className="cmp-search-criteria__content__query-input__search">
          ...
          <div
            className="cmp-search-criteria__content__query-input__search__clear"
            onClick={() => onClear()}
          >
