...
public class SubNavLinksTest {
    ...
    void setUp() {
        ...
        when(cfResource.getPath()).thenReturn("content/techdata");
        when(resolver.getResource("content/techdata-children")).thenReturn(cfResource);
        when(resolver.getResource("content/techdata" + "/jcr:content/data/master")).thenReturn(cfResource);
    ...
    void testchildJsonIterator(){
        ...
        subNavLinks.childJsonIterator(jsonArray,"www.techdata.com");
    }
    @Test
