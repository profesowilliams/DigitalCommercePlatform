...
const outputPath = path.resolve(
  __dirname,
  '../ui.apps/src/main/content/jcr_root/apps/tds-core/clientlibs/clientlib-web-components/css/components.css'
);
...
async function buildCSS() {
  try {
    ...
    console.log(
      `${gray('../ui.apps/src/main/content/jcr_root/apps/tds-core/clientlibs/clientlib-web-components/css/')}${cyan(
        'components.css'
