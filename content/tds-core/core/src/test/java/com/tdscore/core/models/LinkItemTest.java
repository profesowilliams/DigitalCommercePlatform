...
public class LinkItemTest {
    ...
    void setUp() {
        ...
        try {
            ...
            field4.set(underTest, "/content/dam/tdscore/catalog/ALT-children");
        } catch (NoSuchFieldException | IllegalAccessException ignored) {
        }
        ...
        try {
            ...
            field6.set(underTest, "/content/tdscore/language-masters/en/products");
        } catch (NoSuchFieldException | IllegalAccessException ignored) {
        }
    ...
    void validateProperties() {
        ...
        assertEquals("/content/dam/tdscore/catalog/ALT-children", underTest.getNavigationCatalogRoot());
        assertEquals("Products", underTest.getPlatformName());
        assertEquals("/content/tdscore/language-masters/en/products", underTest.getNavigationRoot());
