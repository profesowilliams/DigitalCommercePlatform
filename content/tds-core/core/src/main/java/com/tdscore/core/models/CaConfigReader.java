...
public class CaConfigReader {
    ...
    private String environmentRequestHeader;
    ...
    private boolean enableIntouchLogin;
    ...
    public void init() {
        ...
        environmentRequestHeader = serviceEndPointsConfiguration.environmentRequestHeader();
    ...
    private void buildIntouchHeaderConfigurationConfigs() {
        IntouchConfiguration intouchConfiguration = page.adaptTo(ConfigurationBuilder.class).as(IntouchConfiguration.class);
        if(intouchConfiguration != null) {
            ...
            enableIntouchLogin = intouchConfiguration.enableIntouchLogin();
        }
    }
    ...
    public String getEnvironmentRequestHeader() {
        return environmentRequestHeader;
    }
