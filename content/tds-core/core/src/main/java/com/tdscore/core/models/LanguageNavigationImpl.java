...
public class LanguageNavigationImpl {
	...
	public static final String RESOURCE_TYPE = "tds-core/components/languagenavigation/v1/languagenavigation";
	...
	public static final String DEFAULT_NAVIGATION_ROOT =  "/content/tds-core";
