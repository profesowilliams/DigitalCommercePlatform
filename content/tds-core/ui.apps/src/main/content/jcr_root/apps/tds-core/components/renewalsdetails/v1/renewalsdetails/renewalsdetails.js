...
use(["../../../common/utils.js"], function(utils) {
    ...
    if (properties) {
      ...
      productLinesList.map(
        (productLinesItem) =>
          (productLines[productLinesItem] =
            properties["./productLines/" + productLinesItem])
      );
      ...
      if (properties["./quotePreview/renewalsUrl"]) {
        quotePreview["renewalsUrl"] = utils.addHtmlIfNeeded(
          utils.transformUrlGivenEnvironment(
            properties["./quotePreview/renewalsUrl"]
          )
        );
      }

      if (this.addressesEndpoint && this.serviceData.uiServiceDomain) {
        quotePreview["addressesEndpoint"] =
          this.serviceData.uiServiceDomain + this.addressesEndpoint;
      }

      quotePreviewList.map(
        (quotePreviewItem) =>
          (quotePreview[quotePreviewItem] =
            properties["./quotePreview/" + quotePreviewItem])
      );
      ...
      if (this.disableMultipleAgreement != null) {
        agreementInfo["disableMultipleAgreement"] =
          this.disableMultipleAgreement;
      }

      agreementInfoList.map(
        (agreementInfoItem) =>
          (agreementInfo[agreementInfoItem] =
            properties["./agreementInfo/" + agreementInfoItem])
      );
      ...
      errorMessagesList.map(
        (errorMessagesItem) =>
          (errorMessages[errorMessagesItem] =
            properties["./errorMessages/" + errorMessagesItem])
      );
      ...
      quoteEditingList.map(
        (quoteEditingItem) =>
          (quoteEditing[quoteEditingItem] =
            properties["./quoteEditing/" + quoteEditingItem])
      );
      ...
      if (properties["./lineItemDetailLabels/lineItemSerialNumberLabel"]) {
        lineItemDetailLabels.serialNumberLabel =
          properties["./lineItemDetailLabels/lineItemSerialNumberLabel"];
      }

      if (properties["./lineItemDetailLabels/lineItemSupportLevelLabel"]) {
        lineItemDetailLabels.supportLevelLabel =
          properties["./lineItemDetailLabels/lineItemSupportLevelLabel"];
      }

      if (properties["./lineItemDetailLabels/lineItemInstanceLabel"]) {
        lineItemDetailLabels.instanceLabel =
          properties["./lineItemDetailLabels/lineItemInstanceLabel"];
      }

      if (properties["./lineItemDetailLabels/lineItemDueDateLabel"]) {
        lineItemDetailLabels.dueDateLabel =
          properties["./lineItemDetailLabels/lineItemDueDateLabel"];
      }

      if (properties["./lineItemDetailLabels/lineItemDurationLabel"]) {
        lineItemDetailLabels.durationLabel =
          properties["./lineItemDetailLabels/lineItemDurationLabel"];
      }

      if (properties["./lineItemDetailLabels/lineItemUsagePeriodLabel"]) {
        lineItemDetailLabels.usagePeriodLabel =
          properties["./lineItemDetailLabels/lineItemUsagePeriodLabel"];
      }
      if (properties["./lineItemDetailLabels/activeSubscriptionId"]) {
        lineItemDetailLabels.subscriptionId =
          properties["./lineItemDetailLabels/activeSubscriptionId"];
      }
      ...
      if (properties["./copyFlyout/copyFlyoutDescription"]) {
        copyFlyout.description =
          properties["./copyFlyout/copyFlyoutDescription"];
      }
      ...
      if (this.serviceData.renewalDetailLineItemEndpoint) {
        jsonObject["uiServiceEndPoint"] =
          this.serviceData.uiServiceDomain +
            this.serviceData.renewalDetailLineItemEndpoint || "";
      }

      if (this.serviceData.manageSubscriptionEndpoint) {
        jsonObject["manageSubscriptionEndpoint"] =
          this.serviceData.uiServiceDomain +
            this.serviceData.manageSubscriptionEndpoint || "";
      }
      ...
      if (
        this.orderRenewalEndpoint != null &&
        this.serviceData.uiServiceDomain
      ) {
      ...
      if (this.serviceData && this.serviceData.enableRequestRevision) {
        jsonObject["enableRequestRevision"] =
          this.serviceData.enableRequestRevision;
      }
